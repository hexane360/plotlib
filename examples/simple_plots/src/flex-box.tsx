...
export function Box(props: {
    ...
    layout.useConstraints(() => [
        (props.width ? [new layout.Constraint(parent.width, layout.Operator.Eq, props.width, layout.Strength.medium)] : []),
        (props.height ? [new layout.Constraint(parent.height, layout.Operator.Eq, props.height, layout.Strength.medium)] : []),
